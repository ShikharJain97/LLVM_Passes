; ModuleID = '/home/shikharj/CS5863_Program_Analysis_work/Assign_1/Programs_Observing_C_Constructs/LLVM-IR-DCE,MEM2REG,SCCP/sccp_dce/10022021_3_sccp_dce.bc'
...
do.end:                                           ; preds = %do.cond
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0), i32 0)
  br label %l1
