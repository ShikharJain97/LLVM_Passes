; ModuleID = '/home/shikharj/CS5863_Program_Analysis_work/Assign_1/SourceToBinary/LLVM-IR-DCE,MEM2REG,SCCP/mem2Reg_dce/10022021_1_dce.bc'
...
sw.bb:                                            ; preds = %if.end
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i32 %conv2, i32 %cc.0)
  br label %sw.bb3

sw.bb3:                                           ; preds = %sw.bb, %if.end
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 %conv2, i32 %cc.0)
  br label %sw.default
